...
// All implementations should embed UnimplementedVesselServiceServer
// for forward compatibility
type VesselServiceServer interface {
	FindAvailable(context.Context, *Specification) (*Response, error)
}

// UnimplementedVesselServiceServer should be embedded to have forward compatible implementations.
